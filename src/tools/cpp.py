...
CPP_TOOLS = [
    ToolDefinition(
        ...
        input_schema={
            "type": "object",
            "properties": {
                "include_versions": {"type": "boolean", "description": "Include version summaries. Defaults to true."},
    ...
    ToolDefinition(
        ...
        input_schema={
            "type": "object",
            "properties": {
                "page_id": {"type": "string", "description": "Custom Product Page resource ID."},
                "include_screenshots": {"type": "boolean", "description": "Include screenshot set summaries."},
            },
            "required": ["page_id"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "promotional_text": {"type": ["string", "null"], "description": "Promotional text. Can change without a new version. Use null to clear."},
                "deep_link": {"type": ["string", "null"], "description": "Deep link URL. Use null to clear."},
                "visible": {"type": "boolean", "description": "Whether the Custom Product Page is visible."},
            },
            "required": ["name"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        name="asc_update_custom_product_page",
    ...
    ToolDefinition(
        name="asc_create_custom_product_page_version",
        description="Create a new version for an existing Custom Product Page.",
        input_schema={
            "type": "object",
            "properties": {
                "page_id": {"type": "string", "description": "Custom Product Page resource ID."},
                "deep_link": {"type": "string", "description": "Deep link URL. Use null to clear."},
            },
            "required": ["page_id"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        name="asc_update_custom_product_page_version",
    ...
    ToolDefinition(
        name="asc_create_custom_product_page_localization",
    ...
    ToolDefinition(
        name="asc_update_custom_product_page_localization",
        description="Update promotional text on a Custom Product Page localization.",
        input_schema={
            "type": "object",
            "properties": {
                "localization_id": {"type": "string", "description": "Custom Product Page localization resource ID."},
                "page_version_id": {"type": "string", "description": "Custom Product Page version resource ID."},
                "locale": {"type": "string", "description": "BCP 47 locale code, e.g. en-US, ja, de-DE."},
                "promotional_text": {"type": ["string", "null"], "description": "Promotional text. Can change without a new version. Use null to clear."},
            },
    ...
    ToolDefinition(
        name="asc_delete_custom_product_page_localization",
    ...
    ToolDefinition(
        name="asc_upload_custom_product_page_screenshot",
