...
VERSIONING_TOOLS = [
    ToolDefinition(
        name="asc_get_version_transition_state",
        description="Read the current or specified App Store version, including its assigned build.",
        input_schema={
            "type": "object",
            "properties": {
                "version_id": {"type": "string", "description": "App Store version resource ID."},
            },
    ...
    ToolDefinition(
        name="asc_list_build_candidates",
        ...
        input_schema={
            "type": "object",
            "properties": {
                "version_string": {"type": "string", "description": "Version string, e.g. 1.2.0."},
                "build_number": {"type": "string", "description": "Build number to filter by."},
                "processing_state": {"type": "string", "description": "Build processing state filter, e.g. PROCESSING, VALID, INVALID."},
                "limit": {"type": "integer", "minimum": 1, "maximum": 200, "description": "Maximum number of results to return."},
            },
            "additionalProperties": False,
        },
        annotations={'readOnlyHint': True, 'destructiveHint': False, 'idempotentHint': True, 'openWorldHint': True},
    ...
    ToolDefinition(
        name="asc_get_review_submissions",
        ...
        input_schema={
            ...
            "properties": {
                "limit": {"type": "integer", "minimum": 1, "maximum": 200, "description": "Maximum number of results to return."},
                "include_items": {"type": "boolean", "description": "Include review submission items in the response."},
            },
            "additionalProperties": False,
        },
        annotations={'readOnlyHint': True, 'destructiveHint': False, 'idempotentHint': True, 'openWorldHint': True},
    ...
    ToolDefinition(
        name="asc_get_product_page_optimization_experiments",
        ...
        input_schema={
            ...
            "properties": {
                "version_id": {"type": "string", "description": "App Store version resource ID."},
                "limit": {"type": "integer", "minimum": 1, "maximum": 200, "description": "Maximum number of results to return."},
                "include_treatments": {"type": "boolean", "description": "Include experiment treatments in the response."},
            },
            "additionalProperties": False,
        },
        annotations={'readOnlyHint': True, 'destructiveHint': False, 'idempotentHint': True, 'openWorldHint': True},
    ...
    ToolDefinition(
        name="asc_get_product_page_optimization_experiment",
        description="Read one product page optimization experiment and, by default, its treatments.",
        input_schema={
            "type": "object",
            "properties": {
                "experiment_id": {"type": "string", "description": "Product page optimization experiment resource ID."},
                "include_treatments": {"type": "boolean", "description": "Include experiment treatments in the response."},
            },
    ...
    ToolDefinition(
        name="asc_create_product_page_optimization_experiment",
        ...
        input_schema={
            ...
            "properties": {
                ...
                "traffic_proportion": {"type": "integer", "minimum": 1, "maximum": 100, "description": "Percentage of traffic for the experiment, 1-100."},
                "platform": {"type": "string", "description": "App platform, defaults to IOS."},
            },
    ...
    ToolDefinition(
        name="asc_update_product_page_optimization_experiment",
        ...
        input_schema={
            ...
            "properties": {
                ...
                "name": {"type": "string", "description": "Display name for the resource."},
                "traffic_proportion": {"type": "integer", "minimum": 1, "maximum": 100, "description": "Percentage of traffic for the experiment, 1-100."},
                "started": {"type": "boolean", "description": "Set to true to start the experiment."},
            },
            "required": ["experiment_id"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        name="asc_delete_product_page_optimization_experiment",
    ...
    ToolDefinition(
        name="asc_list_product_page_optimization_treatments",
    ...
    ToolDefinition(
        name="asc_get_product_page_optimization_treatment",
        description="Read one treatment for a product page optimization experiment.",
        input_schema={
            "type": "object",
            "properties": {
                "treatment_id": {"type": "string", "description": "Experiment treatment resource ID."},
            },
    ...
    ToolDefinition(
        name="asc_create_product_page_optimization_treatment",
        ...
        input_schema={
            ...
            "properties": {
                "experiment_id": {"type": "string", "description": "Product page optimization experiment resource ID."},
                "name": {"type": "string", "description": "Display name for the resource."},
                "app_icon_name": {"type": "string", "description": "Alternative app icon asset name for the treatment."},
                "use_v2_relationship": {"type": "boolean", "description": "Use the v2 experiment relationship. Defaults to true."},
            },
    ...
    ToolDefinition(
        name="asc_update_product_page_optimization_treatment",
        ...
        input_schema={
            ...
            "properties": {
                "treatment_id": {"type": "string", "description": "Experiment treatment resource ID."},
                "name": {"type": "string", "description": "Display name for the resource."},
                "app_icon_name": {"type": ["string", "null"], "description": "Alternative app icon asset name for the treatment."},
            },
            "required": ["treatment_id"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        name="asc_delete_product_page_optimization_treatment",
    ...
    ToolDefinition(
        ...
        input_schema={
            ...
            "properties": {
                "version_string": {"type": "string", "description": "Version string, e.g. 1.2.0."},
                "platform": {"type": "string", "description": "App platform, defaults to IOS."},
                "release_type": {"type": "string", "description": "Release strategy: AFTER_APPROVAL, MANUAL, or SCHEDULED."},
                "earliest_release_date": {"type": "string", "description": "ISO 8601 date for scheduled releases."},
                "copyright": {"type": "string", "description": "Copyright text for the version."},
            },
    ...
    ToolDefinition(
        ...
        input_schema={
            ...
            "properties": {
                "version_id": {"type": "string", "description": "App Store version resource ID."},
                "release_type": {"type": "string", "description": "Release strategy: AFTER_APPROVAL, MANUAL, or SCHEDULED."},
                "earliest_release_date": {"type": ["string", "null"], "description": "ISO 8601 date for scheduled releases."},
                "copyright": {"type": ["string", "null"], "description": "Copyright text for the version."},
                "uses_idfa": {"type": "boolean", "description": "Whether the app uses the Advertising Identifier."},
            },
            "required": ["version_id"],
            "additionalProperties": False,
        },
    ...
    ToolDefinition(
        name="asc_assign_build_to_version",
        description="Assign a processed build to an App Store version.",
        input_schema={
            "type": "object",
            "properties": {
                "version_id": {"type": "string", "description": "App Store version resource ID."},
                "build_id": {"type": "string", "description": "Build resource ID to assign."},
            },
    ...
    ToolDefinition(
        name="asc_release_app_store_version",
    ...
    ToolDefinition(
        name="asc_add_custom_product_page_version_to_review_submission",
        ...
        input_schema={
            "type": "object",
            "properties": {
                "review_submission_id": {"type": "string", "description": "Review submission resource ID."},
                "page_version_id": {"type": "string", "description": "Custom Product Page version resource ID."},
            },
